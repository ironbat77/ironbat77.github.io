...
function StackOverflowFlair(svg, x, y) {
  ...
  const PROFILE_URL = "https://stackoverflow.com/users/3478242/iron_bat?tab=profile";
  const ACCOUNT_INFO = "https://api.stackexchange.com/2.2/users/3478242?order=desc&sort=reputation&site=stackoverflow";
